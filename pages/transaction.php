            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 mt-4">
                        <form method="POST" action="../pages/invoice.php?id=<?= $kuota[$id] ?>">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check">
                                <?php foreach ($topping as $t) : ?>
                                    <input class="form-check-input" type="checkbox" value="<?= $t['harga'] ?>" id="topping">
                                    <label class="form-check" for="topping">
...
<script>
    let topping = document.querySelectorAll('input[type="checkbox"]'); //membuat variable topping dengan selector dari inputan type elemen checkbox di halaman
    ...
    topping.forEach((t) => { //foreach dengan nilai (t) untuk melakukan iterasi pada checkbox yang dipilih sebelumnya lalu menambahkan addEventListener
        t.addEventListener('change', function() { //mendeteksi atau melakukan perubahan 
            ...
            //mengubah value pada inputan dengan id total diisi dengan totalHarga yang menghitung total harga keseluruhan
        });
    });
</script>